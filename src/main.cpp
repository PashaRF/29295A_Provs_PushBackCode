...
/*ez::Drive chassis(
    ...
    {-14, -9, -5},  // Right Chassis Ports (negative port will reverse it!)
...
void opcontrol() {
  ...
  //chassis.drive_brake_set(MOTOR_BRAKE_COAST);
   ...
   /* chassis.opcontrol_tank();  // Tank control
    ...
    // senses/runs motors for boolean control inputs
    setFullIntake(master.get_digital(DIGITAL_L1) - master.get_digital(DIGITAL_L2) * 127);
    setIntake(master.get_digital(DIGITAL_R1) - master.get_digital(DIGITAL_R2) * 127);
    setPreroller(master.get_digital(DIGITAL_UP) - master.get_digital(DIGITAL_DOWN) * 127);
